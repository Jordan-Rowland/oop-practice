...
def nearest_neighbours(model_colors, target_colors, num_neighbours=5):
...
def name_colors(model_colors, target_colors, num_neighbours=5):
    for target, near in nearest_neighbours(
        model_colors, target_colors, num_neighbours=5
    ):
        print(target, near)
...
def process_colors(filename='colors.csv'):
